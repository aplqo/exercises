...
const unsigned int maxv = maxn + maxm + 1, maxe = (maxn * maxm + maxn + maxm) * 2;
using cost_t = int;
...
void addDirEdge(const unsigned int from, const unsigned int to, const cost_t cap)
{
    static Edge* cur = ed;
    cur->from = from;
    cur->to = to;
...
inline void addEdge(const unsigned int from, const unsigned int to, const cost_t cap)
{
