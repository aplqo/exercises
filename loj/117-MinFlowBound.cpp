...
inline void addBoundEdge(const unsigned int from, const unsigned int to,
                         const Flow low, const Flow up)
{
  acc[from] -= low;
  acc[to] += low;
...
static Edge* buildGraph(const unsigned int n, const unsigned int s,
