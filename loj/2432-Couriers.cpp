...
class SegmentTree {
 public:
  ...
  void increase(const unsigned int l, const unsigned int r,
                const SegmentTree* old, const unsigned int pos);
  unsigned int find(const unsigned int l, const unsigned int r,
                    const SegmentTree* old, const unsigned int len) const;
...
SegmentTree SegmentTree::node[maxn * maxl * 4 + 100],
    *SegmentTree::cur = SegmentTree::node;
...
void SegmentTree::increase(const unsigned int l, const unsigned int r,
                           const SegmentTree* old, const unsigned int pos)
{
...
unsigned int SegmentTree::find(const unsigned int l, const unsigned int r,
                               const SegmentTree* old,
