...
{
public:
    void build(const unsigned int l, const unsigned int r, Plan*(&p), Plan* const ed, SegmentTree*(&cur));
...
void SegmentTree::build(const unsigned int l, const unsigned int r, Plan*(&p), Plan* const ed, SegmentTree*(&cur))
{
