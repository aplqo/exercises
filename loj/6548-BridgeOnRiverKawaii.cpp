...
inline bool Disjoint::isConnect(const unsigned int x, const unsigned int y) const
{
...
void SegmentTree::insert(const unsigned int l, const unsigned int r, const Edge* e)
{
    if (l == lv && r == rv)
    {
        ed.push_back(e);
...
pair<unsigned int, const Edge*> readQuery(const unsigned int n, const unsigned int q)
{
