...
inline const Edge* addEdge(const unsigned int from, const unsigned int to, const Flow cap)
{
    static Edge* cur = ed;
...
inline void addRangeEdge(const unsigned int id, const unsigned int from, const unsigned int to, const Flow low, const Flow up)
{
    acc[from] -= low;
    acc[to] += low;
