...
int main(int, char* argv[])
{
    ...
    std::uniform_int_distribution<unsigned int> disk(1, MayBe(atoi(argv[2]), maxk));
    std::uniform_int_distribution<unsigned long long> disl(1ull, MayBe(atoll(argv[3]), maxl));
