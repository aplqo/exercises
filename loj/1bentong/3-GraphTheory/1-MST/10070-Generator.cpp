...
void createGraph(ostream& in, const unsigned int n, const unsigned int m, const unsigned int mc)
{
...
int main(int, char* argv[])
{
    ...
    const unsigned int m = GetRandom(1, min<int>(n * (n - 1) / 2, MayBe(atoi(argv[2]), maxm)));
    ofstream in(argv[4]);
    in << n << " " << m << endl;
