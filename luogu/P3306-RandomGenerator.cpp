...
Pol go(const Pol ini, const unsigned long long step,
       const unsigned long long mod)
{
  Pol ret = ini;
...
unsigned long long bsgs(const Pol ini, const unsigned int p,
                        const unsigned int x1, const unsigned int mod)
{
