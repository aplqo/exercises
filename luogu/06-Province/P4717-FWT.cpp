...
inline void reverseCopy(unsigned long long dest[], const unsigned long long src[], const unsigned int sz)
{
...
int main()
{
    ...
    fwt(
        ...
        [](unsigned long long a, unsigned long long& b) { b = (b + mod - a) % mod; });
    ...
    fwt(
        ...
        [](unsigned long long& a, unsigned long long b) { a = (a + mod - b) % mod; });
    copy(res, res + sz, ostream_iterator<unsigned long long>(cout, " "));
    cout.put('\n');
