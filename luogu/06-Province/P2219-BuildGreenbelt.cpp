...
public:
    ...
    num front() const
    {
        return q.empty() ? inf : q.front().second;
    }
    void clear()
    {
        q.clear();
...
inline num sum(const unsigned int u, const unsigned int v, const unsigned int du, const unsigned int dv)
{
