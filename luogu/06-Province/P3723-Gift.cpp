...
void dft(const T src[], const unsigned int slen, Complex dest[],
...
void fft(const long long a[], const unsigned int la, const long long b[],
         const unsigned int lb, long long dest[])
{
