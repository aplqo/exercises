...
void multiplyWith(const Number vx[], const Number b[], Number dest[],
...
void prefixSum(const Number pOrig[], const Number k, Number dest[],
               const unsigned int lgn)
{
...
void difference(const Number pOrig[], const Number k, Number dest[],
                const unsigned int lgn)
{
  static Number mul[maxn + 10];
  const unsigned int n = 1u << lgn;
