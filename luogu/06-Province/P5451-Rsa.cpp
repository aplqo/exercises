...
inline unsigned long long inverse(const unsigned long long x, const long long mod)
{
    long long a, b;
    exgcd(x, mod, a, b);
    return (a % mod + mod) % mod;
}
inline pair<long long, long long> solveEquation(const unsigned long long a, const unsigned long long b)
{
    long long x, y;
    exgcd(a, b, x, y);
...
unsigned long long solve(unsigned long long c1, unsigned long long c2,
    const unsigned long long e1, const unsigned long long e2,
