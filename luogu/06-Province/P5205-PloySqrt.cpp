...
void convolution(const Number a[], const Number b[], Number out[],
...
inline void ntt(const Number a[], const Number b[], Number out[],
                const unsigned int lgn)
{
  convolution<0, 0>(a, b, out, lgn, multiplies<Number>());
}
template <unsigned int ia, unsigned int ib>
inline void updateInverse(const Number a[], const Number old[], Number out[],
                          const unsigned int lgn)
{
  convolution<ia, 1 + ib>(a, old, out, lgn,
