...
char inbuf[maxn * 20 + maxq * 20 * 3 + 1000],
    *inpos = inbuf, outbuf[maxq * 20 + 1000], *outpos = outbuf;
...
void writeUInt(const unsigned int v) { outpos += sprintf(outpos, "%u\n", v); }
