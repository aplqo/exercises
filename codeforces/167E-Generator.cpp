...
inline void createDAG(ostream& in, const unsigned int n, const unsigned int endpoint, const unsigned int m)
{
...
void createGraph(ostream& in, const unsigned int n, const unsigned int endpoint, const unsigned int ignore, const unsigned int m)
{
    iota(shf, shf + n, 1);
...
int main(int, char* argv[])
{
    ...
    const unsigned int ignore = GetRandom(0u, n - 2), endpoint = GetRandom(1u, (n - ignore) / 2);
