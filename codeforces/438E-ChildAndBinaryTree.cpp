...
void convolution(const Number a[], const Number b[], Number dest[],
                 const unsigned int lgn, const Func pred)
{
...
inline void ntt(const Number a[], const Number b[], Number dest[],
                const unsigned int lgn)
{
  convolution<ia, ib>(a, b, dest, lgn, multiplies<Number>());
}
template <unsigned int ia, unsigned int ib>
inline void updateInverse(const Number a[], const Number old[], Number dest[],
                          const unsigned int lgn)
{
  convolution<ia, ib + 1>(a, old, dest, lgn,
