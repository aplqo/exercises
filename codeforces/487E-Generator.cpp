...
void createQuery(ofstream& in, const unsigned int n, const unsigned int q, const unsigned int mw)
{
...
unsigned long long inRange(unsigned long long v, const unsigned long long l, const unsigned long long r)
{
...
int main(int, char* argv[])
{
    ...
    const unsigned int m = GetRandom(n - 1ull, inRange(MayBe(atoi(argv[2]), maxm), n - 1, 1ull * n * (n - 1) / 2));
