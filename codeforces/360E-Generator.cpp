...
void createPath(const unsigned int n, const unsigned int len, const unsigned int s, const unsigned int t)
{
...
void createGraph(const unsigned int n, const unsigned int cnt, const unsigned int s1, const unsigned int s2, const unsigned int t)
{
...
void createWeight(ofstream& in, const unsigned int k, const unsigned int m, const unsigned int mv)
{
...
int main(int, char* argv[])
{
    ...
    in << n << " " << m << " " << k << "\n";
    uniform_int_distribution<unsigned int> dis(1, n);
    const unsigned int s1 = dis(default_rnd), s2 = dis(default_rnd), f = dis(default_rnd);
    in << s1 << " " << s2 << " " << f << "\n";
