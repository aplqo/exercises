...
constexpr Floor ninf = -(__int128_t(1) << 126) / __int128_t(maxl); //numeric_limits<Floor>::lowest() / maxl;
...
unsigned long long binarySearch(const unsigned long long m, const unsigned int ml)
{
    Matrix cm {};
