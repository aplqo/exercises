...
void add(const unsigned int root, const Range tr, const unsigned int v, const Range ar) // tr: node range, ar: add range
{
    if (tr == ar)
    {
        if (f == In)
...
void addEdge(const unsigned int n, const unsigned int root[2], const Range l, const Range r)
{
