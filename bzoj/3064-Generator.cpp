...
void createQuery(ofstream& in, const unsigned int n, const unsigned int e,
                 const int mnv, const int mxv)
{
...
int main(int, char* argv[])
{
  ...
  const int mnv = MayBe(atoi(argv[3]), -2147483647),
            mxv = MayBe(atoi(argv[4]), maxz);
  ofstream in(argv[5]);
  in << t << "\n";
