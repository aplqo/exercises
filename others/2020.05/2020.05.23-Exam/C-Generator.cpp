...
void createGraph(ofstream& f, const unsigned int n, const unsigned int m, const unsigned int mv)
{
...
int main(int argc, char* argv[])
{
    ...
    const unsigned int m = GetRandom(1u, min<unsigned int>(MayBe(stoi(argv[2]), maxm), n * (n - 1) / 2));
    ofstream in(argv[5]);
    in << n << " " << m << endl;
