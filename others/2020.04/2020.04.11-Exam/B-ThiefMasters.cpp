/*
* Luogu team T129184: Thief Masters
*/
#ifdef APTEST
...
num rrang[maxn + 10][maxn + 10][2], brang[maxn + 10][maxn + 10][2]; //row max/min, block max/min
...
void PrintTable(const num dat[maxn + 10][maxn + 10][2], const unsigned int a, const unsigned int b, const unsigned int n)
{
    for (unsigned int i = 0; i < a; ++i)
    {
