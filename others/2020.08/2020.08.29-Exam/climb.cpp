...
static unsigned int init(const unsigned int n)
{
    ...
    sort(p + 1, p + 1 + n, [](const Pill a, const Pill b) { return a.a - a.b > b.a - b.b; });
    unsigned int e = n + 1;
    for (unsigned int i = 1; i <= n; ++i)
    {
...
unsigned int binaryFind(const unsigned int e, const unsigned int beg, const long long x, const long long lim)
{
