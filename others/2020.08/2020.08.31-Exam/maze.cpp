...
struct Matrix
{
    ...
    const unsigned int* operator[](const unsigned int ind) const { return val[ind]; }
...
public:
    ...
    unsigned int query(const unsigned int x1, const unsigned int y1, const unsigned int x2, const unsigned int y2) const;
...
unsigned int STree::query(const unsigned int x1, const unsigned int y1, const unsigned int x2, const unsigned int y2) const
{
