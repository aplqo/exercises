...
unsigned long long createA(ostream& in, const unsigned int n, const unsigned int ma)
{
...
void createQuery(ostream& in, const unsigned int mq, const unsigned int ma, unsigned long long suma, unsigned int k, unsigned int n)
{
...
int main(int, char* argv[])
{
    ...
    const unsigned int ik = GetRandom(0ull, min(sa - n, MayBe<unsigned long long>(atoi(argv[3]), maxk)));
    in << n << " " << q << " " << ik << '\n';
    in << os.str();
