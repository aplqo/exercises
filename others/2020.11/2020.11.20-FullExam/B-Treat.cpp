...
template <bool start>
static void dpChain(const unsigned int n, const unsigned int m, const unsigned int a, const unsigned int b)
{
    Number(*const f)[maxn + 10][2] = gf[start], (*const sum)[maxn + 10][2] = gsum[start];
    if (start)
    {
...
Number dp(const unsigned int n, const unsigned int m, const unsigned int a, const unsigned int b)
{
    dpChain<0>(n, m, a, b);
    dpChain<1>(n, m, a, b);
    Number ret = 0;
