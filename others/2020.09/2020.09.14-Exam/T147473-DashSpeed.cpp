...
namespace dsu
{
    ...
    inline Chain mergeBlock(const unsigned int x, const unsigned int rf, const unsigned int rt)
    {
...
inline void addEdge(const unsigned int from, const unsigned int to, const unsigned int l, const unsigned int r)
{
    Lca::addEdge(from, to);
