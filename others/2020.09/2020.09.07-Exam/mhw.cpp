...
template <unsigned int typ>
void QueryCover(const unsigned int n, const unsigned int cq,
...
static void GetCover(const unsigned int n, const unsigned int m,
                     const unsigned int d)
{
  const unsigned int cqw = InitQuery<without>(m, d),
                     cwo = InitQuery<with>(n, d);
  const unsigned int cyw = discretize<with>(n, cqw),
                     cyo = discretize<without>(m, cwo);
...
template <unsigned int typ>
pair<unsigned long long, unsigned long long> count(const unsigned int c1,
